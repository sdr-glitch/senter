...
| 파일 | 역할 |
|---|---|
| `index.html` | 전체 마크업 (탭 10개: 사무실·AI직원·멘토채팅·홈·생산성·릴스/숏츠·트렌드·스튜디오·자료실·설정) |
| `app.js` | 전체 로직 (~5000줄, 섹션 주석으로 구분) |
